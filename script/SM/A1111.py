...
version = "v1.10.1"
repo = f"git clone -q -b {version} https://github.com/AUTOMATIC1111/stable-diffusion-webui"
...
def webui_req():
    time.sleep(1)
    pull(f"https://github.com/Krek12/segsmaker a1111 {WEBUI}")
    ...
    scripts = [
        f"https://github.com/Krek12/segsmaker/raw/main/script/SM/controlnet.py {WEBUI}/asd",
