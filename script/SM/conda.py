...
scripts = [
    f"curl -sLo {pantat} https://github.com/Krek12/segsmaker/raw/main/script/SM/pantat88.py",
    f"curl -sLo {css} https://github.com/Krek12/segsmaker/raw/main/script/SM/pantat88.css",
    f"curl -sLo {nenen} https://github.com/Krek12/segsmaker/raw/main/script/SM/nenen88.py",
    f"curl -sLo {startup}/00-startup.py https://github.com/Krek12/segsmaker/raw/main/script/SM/00-startup.py",
    f"curl -sLo {startup}/util.py https://github.com/Krek12/segsmaker/raw/main/script/SM/util.py",
    f"curl -sLo {img} https://github.com/Krek12/segsmaker/raw/main/script/SM/loading.png",
    f"curl -sLo {startup}/cupang.py https://github.com/Krek12/segsmaker/raw/main/script/SM/cupang.py"
]
