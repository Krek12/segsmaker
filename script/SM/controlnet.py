...
IMG = "https://github.com/Krek12/segsmaker/raw/main/script/SM/loading.png"
...
def Controlnet_Widgets():
    z = [(CSSCN, f"curl -sLo {CSSCN} https://github.com/Krek12/segsmaker/raw/main/script/SM/controlnet.css")]
    try:
